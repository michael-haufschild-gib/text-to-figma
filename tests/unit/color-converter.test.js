...
let hexToRgb, rgbToHex, getRelativeLuminance, getContrastRatio, validateContrast;
...
async function loadColorUtils() {
  try {
    ...
    rgbToHex = colorModule.rgbToHex;
    getRelativeLuminance = colorModule.getRelativeLuminance;
 ...
 */
function testContrastValidation() {
  ...
  const medium = validateContrast({ r: 100, g: 100, b: 100 }, { r: 255, g: 255, b: 255 });
 ...
 */
function testPerceptualUniformity() {
